---
title: Sending Single-Product Template Messages
deprecated: false
hidden: true
metadata:
  robots: index
---
Single-Product Message (SPM) templates are marketing templates used to showcase a single product from an ecommerce catalog. They include the product image, title, and price (pulled from the catalog), along with customizable body text, an optional footer, and an interactive View button.
