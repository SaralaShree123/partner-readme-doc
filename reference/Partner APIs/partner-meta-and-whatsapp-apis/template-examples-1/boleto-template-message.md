---
title: Boleto Template Message
excerpt: Use this API to send a boleto template message to a WhatsApp user.
deprecated: false
hidden: false
metadata:
  robots: index
...
```curl
curl --location 'https://partner.gupshup.io/partner/app/5a352f84-f8b1-4d4c-a812-a70357148222/v3/message' \
--header 'token: sk_82d7e1d658c4439c9cb0ba57a6ee132d' \
                                ...
                                "payment_settings": [
                                    {
                                        "type": "boleto",
                                        "boleto": {
                                            "digitable_line": "846600000000440000641009013645834345925078459722"
                                        }
                                    }
                                ]
                            }
