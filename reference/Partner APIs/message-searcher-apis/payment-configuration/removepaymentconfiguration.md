---
title: Remove payment configuration
api:
  file: Payment_Configuration_APIs.json
  operationId: removePaymentConfiguration
hidden: true
---
Use this API to remove a payment configurations for a particular app.
...
```curl
curl --location 'https://partner.gupshup.io/partner/app/{{APPID}}/payment/configuration/remove' \
