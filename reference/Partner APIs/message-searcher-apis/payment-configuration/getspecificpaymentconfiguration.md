---
title: Fetch specific payment configuration
api:
  file: Payment_Configuration_APIs.json
  operationId: getSpecificPaymentConfiguration
hidden: true
---
Use this API to fetch the particular payment configurations for a particular app.
...
```curl
curl --location 'https://partner.gupshup.io/partner/app/{{APPID}}/payment/configurations/{configuration_name}'\
