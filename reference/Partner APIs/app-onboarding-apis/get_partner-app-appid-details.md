...
| :------------- | :-------------------------------------------- | :-------------------------------------------------------------------------------------------------------------- | :---------------- | :----- | :---- |
| PARTNER\_TOKEN | JWT Token issues post Partner login           | Should be a valid Partner JWT Token.                                                                            |                   | String |       |
| appId          | id of the app for which data is to be fetched | - The id should be a valid app Id of gupshup  - App should be in the account whose PARTNER\_TOKEN is being used |                   | String |       |
