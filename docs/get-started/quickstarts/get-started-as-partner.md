---
summary: Get Started as a Partner
...
> 📘 Tech providers are a new construct introduced by Meta on 31st Jan 2024. Learn more about [_tech providers_](https://support.gupshup.io/hc/en-us/articles/35249666388889).
...
Partners can use a self serve portal, for their customers WABA management. We also offer a white labeled user interface called Partner Customer Portal. Partner customer portal is a white labeled UI offering which can be branded with the partner logo. Partner customer portal is intended to be used by partner customers i.e., businesses which are served by the partner.

> 📘 Note
>
> We keep enhancing partner APIs to support new features launched by Meta.
