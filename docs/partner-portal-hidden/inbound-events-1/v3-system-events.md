---
summary: v3 System events
title: v3 System events
deprecated: false
hidden: true
metadata:
  robots: index
...
### MM LITE Webhook Events

Upon successful completion of the MM Lite onboarding flow and all associated backend processes, a new **account\_update** webhook will be triggered for each WhatsApp Business Account (WABA) linked to the Business Manager ID (BMID), signifying successful onboarding.
