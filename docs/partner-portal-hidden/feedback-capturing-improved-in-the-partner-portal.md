---
summary: Capturing Feedback in the Partner Portal
title: Capturing Feedback in the Partner Portal
excerpt: ''
deprecated: false
hidden: true
metadata:
...
<Image align="center" className="border" width="100% " border={true} src="https://files.readme.io/fef94ef-Presentation1.png" />
